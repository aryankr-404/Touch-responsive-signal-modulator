...
#define WaveDAC8_DEFAULT_RANGE    (16u) /* Default DAC range */
...
#define WaveDAC8_DAC_RANGE      ((uint8)(16u << 2u) & WaveDAC8_RANGE_MASK)
#define WaveDAC8_DAC_POL        ((uint8)(16u >> 1u) & WaveDAC8_IDIR_MASK)
