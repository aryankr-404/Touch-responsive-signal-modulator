...
#define CY_CFG_BASE_ADDR_COUNT 28u
...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000370u)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000378u)

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x48000380u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x00EFu);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT5_AG, 0x80u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW0, 0x09u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP2_MX, 0x0101u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BUS_SW0, 0x08u);
...
uint8 CYXDATA * const CYCODE CapSense_CSD_AMuxCH0__addrTable[10] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE CapSense_CSD_AMuxCH0__maskTable[10] = {
	0x40u, 
	0x20u, 
	0x01u, 
	0x02u, 
...
/*******************************************************************************
* Function Name: CapSense_CSD_AMuxCH0_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void CapSense_CSD_AMuxCH0_Set(uint8 channel)
{
	if (channel < 10)
	{
...
/*******************************************************************************
* Function Name: CapSense_CSD_AMuxCH0_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void CapSense_CSD_AMuxCH0_Unset(uint8 channel)
{
	if (channel < 10)
	{
...
void cyfitter_cfg(void)
{
...

	{
		...
		/* B0_P4_U1_CFG24 Starting address: CYDEV_UCFG_B0_P4_U1_CFG24 */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P4_U1_CFG24), 0x84000404u);
